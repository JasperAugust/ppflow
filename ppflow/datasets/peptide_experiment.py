...
class PairDataset(Dataset):
    ...
    def __init__(
        ...
        self._load_split(split_seed, reset)
    ...
    def _preprocess_structures(self):
        ...
        for protein_name in protein_names:
            task = {
                'receptor_path': os.path.join(self.data_dir, protein_name, 'receptor.pdb'), 
                'peptide_path': os.path.join(self.data_dir, protein_name, 'peptide.pdb'),
